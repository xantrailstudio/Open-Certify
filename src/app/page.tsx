      ...
      <div style={{ marginTop: "6rem", width: "100%" }}>
        ...
        {[
          ...
          <div key={section.track} style={{ marginBottom: "3rem" }}>
            <h3 style={{ fontSize: "1.1rem", marginBottom: "1rem", paddingBottom: "0.5rem", borderBottom: "1px solid var(--border-color)", color: "var(--text-muted)" }}>
              {section.track}
            </h3>
